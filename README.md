...
Добро пожаловать в мое портфолио! Здесь вы найдете подборку проектов, которые я выполнил, главным образом используя Python. Каждый проект сопровождается кратким описанием, а его название является активной ссылкой.

---

## О себе

Салам алейкум! Меня зовут Олежа Нестеров, я студент первого курса и мне 20 лет. Мое увлечение – программирование и веб-разработка.

### 🎓 Образование
- **Специальность:** Информационные системы и технологии (ККОТиП), Информационные системы и технологии (неоконченное, ТУСУР)
- **Курс:** Первый курс

### 🔧 Навыки

#### Языки программирования
- **Python:** Опыт в разработке различных проектов, создание графических интерфейсов.
- **HTML:** Основы для создания и редактирования веб-страниц.
- **C++:** Использую редко, но знаком с основами.

#### Графические библиотеки Python
- **Tkinter:** Разработка простых и удобных графических интерфейсов.
- **CustomTkinter:** Дополнительные возможности для настройки графических интерфейсов.
- **PyQt6:** Создание сложных и функциональных графических интерфейсов.

#### Веб-разработка
- **WordPress:** Создание и управление веб-сайтами на базе WordPress.
- **HTML:** Базовые навыки для верстки и редактирования веб-страниц.

### 🌟 О себе
Я люблю создавать проекты, которые решают реальные задачи и приносят пользу людям. Всегда открыт для новых возможностей и готов принять вызов.
